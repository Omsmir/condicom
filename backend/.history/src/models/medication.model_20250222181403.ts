...
// Medication Input Interface (User-provided data)
...
// Medication Document Interface (Extends Input & Mongoose Document)
...
// Mongoose Model
export const Medication: Model<MedicationDocument> = mongoose.model<MedicationDocument>("Medication", medicationSchema);
