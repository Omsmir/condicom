...
import { createUser, findUser, getAllUsers, updateUser } from "../services/user.service";
...
export const getAllUsersHandler = async (req: Request, res: Response) => {
  try {
    ...
    const Users = await getAllUsers({_id:{$no:user._id},role:{$no:["Charge Nurse","Head Nurse","Head Secretary","Charge Secretary"]}})
