...
import { createAppointment, findUserAppointments } from "../services/appointments.service";
  ...
  next: NextFunction
    ...
    try {
        ...
        const reservedFrontDates = () => {
          ...
          const newAppointment = await createAppointment({user:userId,...req.body})
...
export const getUserAppointments = async (req: Request<{}, {}, AppointmentSchemaInterface["body"]>,
    res: Response,) => {
        try {
