...
import { GetmedicationSchemaInterface, medicationSchemaInterface } from "../schemas/medication.schema";
import {
  createMedication,
  deleteMedication,
...
export const getAllMedicationsHandler = async   req: Request<GetmedicationSchemaInterface['params']>,
res: Response) => {
    try {
