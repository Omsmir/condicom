...
import { AddAdditionalInterface, CreateUserInterface } from "../schemas/user.schema";
...
export const AddAdditionlHandler = async (
  ...
  next: NextFunction
    ...
    try {
        ...
        const updatedUser = await updateUser({_id:id},{...req.body,profileImg:profileImg},{new:true,runValidators:true})
