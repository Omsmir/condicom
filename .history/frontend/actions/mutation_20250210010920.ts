    ...
    return useMutation({
        ...
        onSettled:async(data,error,variables)=>{
            if (error) {
              ...
              await queryClient.invalidateQueries({queryKey:["userAppointments",variables]})
        }
    })
}
    ...
    return useMutation({
        ...
        onSettled:async(data,error,variables)=>{
            if (error) {
              ...
              await queryClient.invalidateQueries({queryKey:["userAppointments",variables.get("userId")]})
        },
