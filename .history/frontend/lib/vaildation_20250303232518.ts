...
import {  characters, firstNumber, genders, medicationCategories, medicationForms, medicationRoutes, medicationStrengths } from "./constants";
...
export const CodeSchema = z.object({
  numbers:z.enum([...firstNumber],{message:"first number is required"}),
  characters:z.enum([...characters]{message:"first number is required"})
})