...
import { gender, genders, medicationForms } from "./constants";
...
export const MedicationSchema = z.object({
  ...
  form:z.enum(medicationForms,{message:"please select the medication form"}),
  ...
  supplier:z.string().min(5).max(25).optional(),
