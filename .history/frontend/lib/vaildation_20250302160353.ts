...
import {  genders, medicationCategories, medicationForms, medicationRoutes, medicationStrengths } from "./constants";
...
export const AccountSchema = z.object({
  name:z.string({message:"please support name"}).min(1,"pleae"),
  occuaption:z.string({message:"please select"})
})