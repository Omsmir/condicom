...
export const MedicationSchema = z.object({
  name:z.string({message:"please write the medication name"}).refine((value) => value !== "",{message:}).min(1,"please write the medication name").max(30,"max characters is 30"),
  generic_name:z.string({message:"please select the generic name"}).min(4,"min characters is 4").max(30,"max characters is 30"),
