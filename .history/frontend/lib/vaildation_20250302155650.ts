...
import {  genders, medicalSpecialties, medicationCategories, medicationForms, medicationRoutes, medicationStrengths } from "./constants";
...
export const AccountSchema = z.object({
  ...
  occuaption:z.enum(medicalSpecialties)
})