...
export const patientSchema = z.object({
  ...
  allergies: z.string({message:"please select an aller"}),
  ...
  smokingFrequency: z.enum(["daily", "occasionally", "rarely"]).optional(),
  alcohol: z.enum(["yes", "no"], {
    required_error: "Please select if you consume alcohol",
  }),
  alcoholFrequency: z.enum(["daily", "occasionally", "rarely"]).optional(),
});
