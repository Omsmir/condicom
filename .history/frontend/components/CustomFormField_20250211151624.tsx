...
const RenderField = ({ field, props }: { field: any; props: CustomProps }) => {
  ...
  switch (props.fieldType) {
    case FormFieldType.INPUT:
      return (
        <div className="flex justify-center items-center rounded-md border bg-slate-100 dark:border-[var(--sidebar-accent)] ">
          {props.Lucide && (
        ...
        <div >
          <FormControl>
            <Calendar
              ...
              showIcon
              className="date-picker pl-2 focus:shadow-none p-calender ml-1"
