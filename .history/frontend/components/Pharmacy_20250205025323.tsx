...
const Pharmacy = async() => {
  ...
  return (
    <DataTable columns={pharmacyColumns} data={data.medications} message={} renderSwitchState="pharmacy" breadCrumbString="doctors" StatsIcon={<MedicalInformationOutlined />} />
