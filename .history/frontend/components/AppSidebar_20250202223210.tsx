    ...
    <Dialog>
      <Sidebar className="border-r dark:border-slate-700 h-screen" collapsible="icon">
        ...
        <SidebarHeader
          ...
          className="flex relative justify-center items-center h-14 px-4 border-b dark:border-slate-700 p-0 min-w-[25px] z-30"
        >
        ...
        <SidebarContent className="flex-1">
          <SidebarGroup className="flex-1 p-0">
            {/* Body */}
            <SidebarGroupContent
              className={clsx("flex-1 w-full pt-10 overflow-hidden", {
                "pt-0": open && !isMobile,
              })}
            >
