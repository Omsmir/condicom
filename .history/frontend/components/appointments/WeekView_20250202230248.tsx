...
const WeekView = ({
  ...
  return (
    <React.Fragment>
      <div className="grid grid-cols-12 border-y shadow-md dark:bg-slate-800 dark:border-slate-700 z-10">
        <div className="sm:col-span-1 border-r sm:min-w-[56px] dark:border-slate-700"></div>
        <div className="grid grid-cols-12 sm:grid-cols-4 lg:grid-cols-7 col-span-12 sm:col-span-10 overflow-hidden bg-[var(--sidebar-background)] dark:bg-slate-800 z-10">
          {DaysOfWeekCalender.map((day, index) => (
            <div
              className={clsx(
                `col-span-3 sm:col-auto flex justify-center items-center sm:border-r ${inter.className} py-3 cursor-pointer hover:bg-slate-100 dark:hover:bg-slate-700  dark:border-slate-700`,
                {
      ...
      <OverlayScrollbarsComponent defer>
        <MotionComponent>
          <div className="grid grid-cols-12">
            ...
            <div className="grid grid-cols-1 border-l sm:grid-cols-4 lg:grid-cols-7 col-span-10 dark:border-slate-700 mb-1">
