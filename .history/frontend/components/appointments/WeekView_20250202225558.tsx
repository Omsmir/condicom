  ...
  return (
    <React.Fragment>
      <div className="grid grid-cols-12 border-y shadow-md dark:bg-slate-800 dark:border-slate-700">
        ...
        <div className="grid grid-cols-12 sm:grid-cols-4 lg:grid-cols-7 col-span-12 sm:col-span-10 overflow-hidden bg-[var(--sidebar-background)] dark:bg-[var(--sidebar-accent)]">
