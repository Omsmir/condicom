...
const SingleInformationRow = ({
  ...
  return (
    <div
      className={cn("flex flex-col items-start col-span-12 sm:col-span-6 md:col-span-4 text-sm", className)}
    >
      <h1 className="text-slate-600 capitalize mb-2">{innerText}</h1>
      {children}
    </div>
  );
};
