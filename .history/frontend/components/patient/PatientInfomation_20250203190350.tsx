...
import { IBM, inter, lato } from '@/fonts/fonts'

const PatientInfomation = ({patient}:{patient:patient | undefined}) => {
  return (
    <section className={`flex flex-col relative m-2 px-4 pt-4 rounded-md bg-[var(--sidebar-background)] z-10 printable ${IBM.className}`}>
