...
const items =[
    {
       ...
       title: <p className="dark:">Patient Information</p> 
    },
    {
        key:"Appointments",
        href:"#Appointments",
        title: <p className="dark:">Appointments</p> 
    },
    {
        key:"Next Treatments",
        href:"#Next Treatments",
        title: <p className="dark:">Next Treatments</p> 
    },
    {
        key:"Medical History",
        href:"#Medical History",
        title: <p className="dark:">Medical History</p> 
    }
]
