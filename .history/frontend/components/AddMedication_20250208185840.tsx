...
import axios from "axios";
import Swal from "sweetalert2";
import { Drawer, Button, Steps } from "@mui/material";
import { Form } from "@/components/ui/form";
import DashboardHook from "@/hooks/useDashboard";
import { useCreateMedication } from "@/actions/mutations";
        ...
        <Form {...form}>
          ...
          >
            <div className="flex flex-col justify-start gap-7">
              <h1 className="text-slate-800 text-center font-bold text-lg dark:text-slate-50">
                Add Medication
              </h1>
              <Steps
                type="navigation"
            ...
            <div className="flex w-full">
              ...
              {current === steps.length - 1 && (
                ...
                >
                  {createMedication.isPending ? "Submitting..." : "Submit"}
                </Button>
              )}
              {current > 0 && (
                <span
