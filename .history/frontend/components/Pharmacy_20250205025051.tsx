...
const Pharmacy = async() => {
  ...
  return (
    <DataTable columns={pharmacyColumns} data={data} message={data.message} renderSwitchState="pharmacy" breadCrumbString="doctors" StatsIcon={<MedicalInformationOutlined />} />
