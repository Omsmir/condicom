...
const Pharmacy = async() => {
  ...
  return (
    <DataTable columns={pharmacyColumns} data={data.medications} hiddenColumns={} renderSwitchState="pharmacy" breadCrumbString="pharmacy" StatsIcon={<MedicalInformationOutlined />} />
