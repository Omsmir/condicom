                ...
                <SidebarMenuSubItem key={subItem.title}>
                  <SidebarMenuSubButton asChild>
                    <Link
                      ...
                      href={subItem.url}
                      className={clsx({
                        "bg-[var(--sidebar-accent)]  text-slate-50 dark:bg-[var(--sidebar-accent)] group":
                          pathname == subItem.url,
                      })}
                    >
                      <div className="text-slate-600 group-hover:text-slate-50 transition-colors">{subItem.title}</div>
                    </Link>
                  </SidebarMenuSubButton>
                </SidebarMenuSubItem>
              ))}
