...
const SingleCode = ({ code, users, isLoading }: SingleCodeProps) => {
  ...
  return (
    <div className="grid grid-cols-12 col-span-6 sm:col-span-4 md:col-span-3 mr-2 mt-4 sm last-of-type:mr-0 p-4  bg-[var(--sidebar-background)] rounded-md shadow-md shadow-slate-300 dark:shadow-slate-800">
