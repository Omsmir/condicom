...
const SingleCode = ({ code, users, isLoading }: SingleCodeProps) => {
  ...
  return (
    <div className="flex flex-col col-span-6 md:col-span-4 min-h-[300px] sm:min-h-[250px] lg:col-span-3 mr-2 mt-4  pt-2 pb-4 px-4  bg-[var(--sidebar-background)] rounded-md shadow-md shadow-slate-300 dark:shadow-slate-800">
