...
const DeleteCode = () => {
  ...
  return (
    <CustomDialog DialogTitle="delete code" DialogType={DialogTypes.CONFIRM} classname="dark:bg-[var(--sidebar-background)] dark:text-slate-50">
      <Form {...form}>
        <form
          onSubmit={form.handleSubmit(onSubmit)}
          className="space-y-8 my-auto px-4 sm:p-0 sm:mx-4 h-full"
        >
          <SubmitButton
            isLoading={isLoading}
