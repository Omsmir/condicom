...
interface AccountUsebleHeaderProps {
  innerText:string;
  showMenu:boolean
}
const AccountUsebleHeader = ({i}:AccountUsebleHeaderProps) => {
  ...
  return (
    ...
    <h1 className="text-lg font-semibold capitalize">Account info</h1>
    <DropdownMenu>
...
export default AccountUsebleHeader
