...
const Account = () => {
  ...
  const userData = {
    ...
    'Account Number': data?.existingUser._id,
    'Date Created': format(data?.existingUser.createdAt as Date,"PPpp"),
    "Last Modified":format(data?.existingUser.updatedAt as Date,"PPpp")
  }
      ...
      <div className="flex flex-col justify-center items-start col-span-12 bg-[var(--sidebar-background)] rounded-md shadow-sm">
        ...
        <div className="grid grid-cols-12 p-4 w-full">
          {Object.entries(userData).map(([key,value]) => (
            ...
            innerText={key}
            className="text-sm capitalize md:cols"
          >
            <CustomSkeleton
