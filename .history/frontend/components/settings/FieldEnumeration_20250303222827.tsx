...
const SelectionField = ({form,value,selectArray}:FieldSelectionProps) => {
  return(
    <CustomFormField
  ...
  >
    {selectArray.map((value, index) => (
      <SelectItem key={index} value={value} className="transition-all hover:bg-slate-200">
...
const FieldEnumeration = ({
  ...
  switch (name) {
    ...
    case "occupation":
        return (
            <SelectionField form={form} value={value} SelectArray={medicalSpecialties} />

        )
    case "height":
        return (
            <SelectionField form={form} value={value} SelectArray={heights} />

        )
    case "weight": 
    return (
        <SelectionField form={form} value={value} SelectArray={weights} />
