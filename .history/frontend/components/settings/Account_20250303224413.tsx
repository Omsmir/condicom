...
const Account = () => {
  ...
  return (
    <div className="grid grid-cols-12 w-full pt-0 p-6">
      {/* Account Information */}
      <ReusebleForm innerText="Account Info" editState={ProfileEdit} setEditState={setProfileEdit} setAnyState={setac} >
        <AccountInfo
          form={form}
      ...
      <ReusebleForm innerText="Related Info" className="mt-6" editState={AccountEdit} setEditState={setAccountEdit}>
        <RelatedInfo
          form={form}
          user={data?.existingUser}
          isFetching={isFetching}
