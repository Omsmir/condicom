...
const SingleAppointment = ({
  ...
  const AppointmentJsx = ({index}:{index:string | undefined}) => {
    return appointments && appointments.length > 0 ? (
      <React.Fragment>
        <SchuduleAppointmentStructure appointments={appointments} isFuture key={index} />
        ...
        <SchuduleAppointmentStructure
          ...
          key={index}
        />
        <SchuduleAppointmentStructure appointments={appointments} key={index}/>
      </React.Fragment>
    ) : (
  ...
  return <AppointmentJsx index={index} />;
};
