...
const SinglePatient = ({patient}:{patient: patient }) => {
  ...
  return (
        <Link href={`/dashboard/patients/${patient._id}`} key={patient.id} className="flex justify-between items-center p-4 hover:bg-slate-200 dark:hover:bg-slate-700 cursor-pointer transition-colors">
