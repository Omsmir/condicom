...
const Pharmacy = async() => {
  ...
  return (
    <DataTable columns={pharmacyColumns} data={data.medications} hiddenColumns={ph} renderSwitchState="pharmacy" breadCrumbString="pharmacy" StatsIcon={<MedicalInformationOutlined />} />
