...
import { AutorenewOutlined, DeleteOutlineOutlined } from "@mui/icons-material";
import { CheckedState } from "@radix-ui/react-checkbox";


type HandleViewFuncProps = {
  handleView: ({ text, setDayView, setMonthView, setWeekView, onclick, setView }: handlefunction) => void
}
type handlefunction = {
  text: string;
  onclick: React.Dispatch<React.SetStateAction<any>>;
  setDayView: React.Dispatch<React.SetStateAction<CheckedState | undefined>>
  setWeekView: React.Dispatch<React.SetStateAction<CheckedState | undefined>>
  setMonthView: React.Dispatch<React.SetStateAction<CheckedState | undefined>>
...
export const handleView = ({text,setDayView,setMonthView,setWeekView,onclick,setView}:handlefunction) => {
  setView(text);
...
export    
const switchOnNotifications = (apiString:string,session:Session | null,id:string | undefined) => {
