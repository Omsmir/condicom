...
import { AutorenewOutlined, Delete, DeleteOutlineOutlined, LocalHospital, LocalHospitalOutlined, MedicalInformationOutlined } from "@mui/icons-material";
...
export const NotificationType = (notification: Notification) => {
  switch (notification.type) {
    ...
    return <MedicalInformationOutlined className="text-green-800" />;
