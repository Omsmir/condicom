...
import { AutorenewOutlined, Delete, DeleteOutlineOutlined, LocalHospital, LocalHospitalOutlined, MedicalInformationOutlined, MedicalServices } from "@mui/icons-material";
...
export const NotificationType = (notification: Notification) => {
  switch (notification.type) {
    ...
    return <MedicalServices className="text-green-800" />;
     case "medication deletion":
     return <DeleteOutlineOutlined className="text-red-800" />;
     case "medication updated":
     return <AutorenewOutlined className="text-red-800" />;
    default:
