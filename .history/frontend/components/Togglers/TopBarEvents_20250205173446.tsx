...
import { AutorenewOutlined, Delete, DeleteOutlineOutlined, LocalHospital, LocalHospitalOutlined } from "@mui/icons-material";
...
export const NotificationType = (notification: Notification) => {
  switch (notification.type) {
    ...
    return <LocalHospitalOutlined className="text-green-800" />;
