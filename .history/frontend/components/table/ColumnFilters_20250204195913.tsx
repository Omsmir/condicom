...
const ColumnFilters = <TData, TValue>({
  ...
  setColumnFilters,
    ...
    const setColumnFilterForGender = (e:any) => {
        return setColumnFilters((prev) => e === "clear" ? prev.filter((ele) => ele.id !==))
    }
  return (
      ...
      {columns.map((column: any) => {
        ...
        return (
          columnId === "gender" && (
            ...
            >
              <SelectTrigger className="shad-select-trigger text-dark-500 max-w-[145px] max-h-[30px]">
