    ...
    <div className="flex pl-0 p-2 ">
      {columns.map((column: any) => {
        ...
        switch (columnId) {
          case "gender":
            return (
              <SelectFilter value={value ?? undefined} setColumnFilterForRows={setColumnFilterForRows}  array={genders} columnId={columnId} />
            );
            case "bloodType":
              return (
                <SelectFilter value={value ?? undefined} setColumnFilterForRows={setColumnFilterForRows}  array={bloodTypes} columnId={columnId} />
              );
          case "firstName":
          case "name":  
            return (
              <Input
                ...
                className="shad-input max-h-[30px] mr-1 caret-purple-50"
              />
            );
          default:
            return null;
