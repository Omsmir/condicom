...
const Pharmacy = async() => {
  ...
  return (
    <DataTable columns={pharmacyColumns} data={data.medications} hiddenColumns={p} renderSwitchState="pharmacy" breadCrumbString="pharmacy" StatsIcon={<MedicalInformationOutlined />} />
