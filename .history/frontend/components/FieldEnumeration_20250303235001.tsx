...
const FieldEnumeration = ({ name, value, form ,label}: FieldEnumerationProps) => {
  switch (name) {
    case "Account Name":
      return (
        <CustomFormField
    ...
    case "characters":
      return (
        <SelectionField name={name} form={form} selectArray={[...characters]} />
      );
    case "fiveNumbers":
      return (
        <SelectionField name={name} form={form} selectArray={[...FiveNumber]} />
      );
