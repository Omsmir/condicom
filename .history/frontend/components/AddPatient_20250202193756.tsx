...
<React.Fragment>
  ...
  PaperProps={{
    sx: {
      width: { xs: "100vw", sm: "80vw", md: "50vw", lg: "630px" }, 
      maxWidth: "640px"
    }
  }}
>
        <Form {...form}>
          <form
            ...
            className="flex flex-col w-full h-full justify-center items-center overflow-auto space-y-10  p-4 dark:bg-[var(--sidebar-accent)]"
          >
