...
export const createMedication = async (req, res, next) => {
  ...
  try {
    if (existedMedication) {
      // Handle stock_quantity separately to avoid overwriting it in loops
      ...
      // Update required fields except stock_quantity
      ...
      // Update optional fields only if they have a value
