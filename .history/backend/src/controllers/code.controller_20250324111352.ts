...
import { codeSchemaInterface, GetcodeSchemaInterface } from "../schemas/code.schema";
import {
  generateCode,
...
export const getCodesHandler = async (
  req: Request<GetcodeSchemaInterface["params"],{},{},GetcodeSchemaInterface["querys"]>,
  res: Response
) => {
  try {
    const id = req.params.id;
