...
import { generateCode, generateExpirationDate, role, signRole } from "../utils/backevents";
...
export const getCodesHandler = async (req:Request<codeSchemaInterface["params"]>,res:Response) => {
  try {
