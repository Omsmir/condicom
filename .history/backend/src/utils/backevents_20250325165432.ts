...
export const detectExpiredCode = ({expiration}:{expiration:string}) =>{
  if(new Date(expiration) < new Date()) return false

  return true
}

console.log(detectExpiredCode({expiration:"2025-04-23T00:48:35.217+00:00"}))