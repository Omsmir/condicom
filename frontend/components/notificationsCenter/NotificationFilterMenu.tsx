...
const NotificationFilterMenu = () => {
    ...
    return (
        ...
        >
            ...
            <MenuItems
                transition
                className="Tailwind-Dropdown "
            >
                <MenuItem>
                    <div
                        className="flex justify-between tailwind-menuItem"
                        onClick={() => handleCheckedFilter({ onclick: setAllFilter })}
                    >
                        <p>All</p>
                ...
                <MenuItem>
                    <div
                        className="flex justify-between tailwind-menuItem"
                        onClick={() => handleCheckedFilter({ onclick: setTodayFilter })}
                    >
                        <p>Today</p>
                ...
                <MenuItem>
                    <div
                        className="flex justify-between tailwind-menuItem"
                        onClick={() => handleCheckedFilter({ onclick: setYesterdayFilter })}
                    >
                        <p>Yesterday</p>
