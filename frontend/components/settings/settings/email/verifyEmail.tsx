      ...
      >
        <div className="flex">
          <p className="text-xs text-slate-500 ">
            this link will or path will expire in 1 hour, so please click the
            verify button to confirm your process
          </p>
        </div>
        <div className="flex w-[250px] space-y-2">
          {verified ? (
            <p className="text-green-800 text-sm capitalize">email verified successfully</p>
          ) : (
            <SubmitButton
